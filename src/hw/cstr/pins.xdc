...
set_property PACKAGE_PIN AK17 [get_ports clk104_pl_clk_p]
set_property IOSTANDARD LVDS [get_ports clk104_pl_clk_p]
set_property IOSTANDARD LVDS [get_ports clk104_pl_clk_n]

#set_property PACKAGE_PIN AL16 [get_ports clk104_pl_sysref_p]
#set_property IOSTANDARD LVDS [get_ports clk104_pl_sysref_p]
#set_property IOSTANDARD LVDS [get_ports clk104_pl_sysref_n]

set_property PACKAGE_PIN AG17 [get_ports clk104_lmkin0_clk_p]
set_property IOSTANDARD LVDS [get_ports clk104_lmkin0_clk_p]
set_property IOSTANDARD LVDS [get_ports clk104_lmkin0_clk_n]


set_property PACKAGE_PIN AP16 [get_ports {dbg[0]}]
...
set_property PACKAGE_PIN AN17 [get_ports {dbg[1]}]
...
set_property PACKAGE_PIN AN16 [get_ports {dbg[2]}]
...
set_property PACKAGE_PIN AR16 [get_ports {dbg[3]}]
...
set_property PACKAGE_PIN AP14 [get_ports {dbg[4]}]
...
set_property PACKAGE_PIN AR14 [get_ports {dbg[5]}]
...
set_property PACKAGE_PIN AW15 [get_ports {dbg[6]}]
...
set_property PACKAGE_PIN AV13 [get_ports {dbg[7]}]
...
set_property PACKAGE_PIN AW16 [get_ports {dbg[8]}]
...
set_property PACKAGE_PIN AP13 [get_ports {dbg[9]}]
...
set_property PACKAGE_PIN AU14 [get_ports {dbg[10]}]
...
set_property PACKAGE_PIN AT16 [get_ports {dbg[11]}]
...
set_property PACKAGE_PIN AU13 [get_ports {dbg[12]}]
...
set_property PACKAGE_PIN AW14 [get_ports {dbg[13]}]
...
set_property PACKAGE_PIN AR13 [get_ports {dbg[14]}]
...
set_property PACKAGE_PIN AU15 [get_ports {dbg[15]}]
...
set_property PACKAGE_PIN AW13 [get_ports {dbg[16]}]
...
set_property PACKAGE_PIN AV16 [get_ports {dbg[17]}]
...
set_property PACKAGE_PIN AT15 [get_ports {dbg[18]}]
...
set_property PACKAGE_PIN AV15 [get_ports {dbg[19]}]
...
set_property PACKAGE_PIN B10 [get_ports {fp_led[0]}]
...
set_property PACKAGE_PIN B8 [get_ports {fp_led[1]}]
...
set_property PACKAGE_PIN B9 [get_ports {fp_led[2]}]
...
set_property PACKAGE_PIN B7 [get_ports {fp_led[3]}]
...
set_property PACKAGE_PIN D9 [get_ports {fp_led[4]}]
...
set_property PACKAGE_PIN C8 [get_ports {fp_led[5]}]
...
set_property PACKAGE_PIN D8 [get_ports {fp_led[6]}]
...
set_property PACKAGE_PIN D10 [get_ports {fp_led[7]}]
